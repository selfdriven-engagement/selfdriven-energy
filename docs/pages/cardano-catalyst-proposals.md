...
|[Powering a Health Cooperative using Cardano, by selfdriven](https://projectcatalyst.io/funds/15/...)<br><small><span style="color:gray">Search: "Health Cooperative"</span></small>|Work with the selfdriven.health to deliver a real use project, based on the co-developed open-source kit - from definition to implementation.|[View](/cardano-catalyst/proposal/health-systems-cooperative/)|
